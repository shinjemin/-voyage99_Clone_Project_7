...
public class CommentLikesController {
    ...
    public Long changeLike(@PathVariable Long commentId, @RequestBody CommentLikesRequestDto commentLikesDto, @RequestHeader("Authorization") String authorization){
